    ...
    switch (i) {
        case 1:
            ...
            if (flag == 'n') {
                ...
                p = fopen("class01.dat", "w");
            }
            break;
        case 2:
            p = fopen("class02.dat", "a");
            break;
        case 3:
            p = fopen("class03.dat", "a");
            break;
        case 4:
            p = fopen("class04.dat", "a");
            break;
        case 5:
            p = fopen("class05.dat", "a");
            break;
        case 6:
            printf("该文件不存在，是否要创建新文件？\n");
            printf("输入\"n\"结束或者输入\"y\"继续\n");
            ...
            if (flag == 'n') {
                ...
                p = fopen("class06.dat", "w");
            }
            break;
        case 7:
            p = fopen("class07.dat", "a");
            break;
        default:
            printf("请输入合法的班级名称\n");
            break;
